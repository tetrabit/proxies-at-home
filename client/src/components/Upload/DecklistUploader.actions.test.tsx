...
describe('DecklistUploader action branches', () => {
    ...
    it('closes remove-basics and clear confirmation modals through cancel actions', async () => {
        renderDecklist(1);
        ...
        await waitFor(() => expect(screen.queryByText('Confirm Clear Cards')).toBeNull());
    });
});
